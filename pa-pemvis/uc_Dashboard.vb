...
#Region "🔹 Navigasi Panel & Efek UI"
    ...
    Private Sub SetupPanelInteractions()
        ...
        Dim navControls() As Control =
    {
        panelOwner, lblOwner,
        panelHewan, lblHewan,
        panelBooking, lblBooking,
        panelPembayaran, lblPembayaran
    }

        For Each ctrl In navControls

            ctrl.Cursor = Cursors.Hand

            AddHandler ctrl.Click,
            AddressOf NavPanel_Click

            AddHandler ctrl.MouseEnter,
            AddressOf NavPanel_Hover

            AddHandler ctrl.MouseLeave,
            AddressOf NavPanel_Leave
    ...
    Private Sub NavPanel_Click(sender As Object, e As EventArgs)
        ...
        ' OWNER
        ' =========================
        If sender Is panelOwner Or sender Is lblOwner Then

            controlName = "uc_dgvOwner"
        ...
        ' HEWAN
        ' =========================
        If sender Is panelHewan Or sender Is lblHewan Then

            controlName = "uc_dgvHewan"
        ...
        ' BOOKING
        ' =========================
        If sender Is panelBooking Or sender Is lblBooking Then

            controlName = "uc_dgvBooking"
        ...
        ' PEMBAYARAN
        ' =========================
        If sender Is panelPembayaran Or sender Is lblPembayaran Then

            controlName = "uc_dgvPembayaran"
    ...
    Private Sub NavPanel_Hover(sender As Object, e As EventArgs)
        ...
        If sender Is lblOwner Then
            panelOwner.BackColor = Color.LightSkyBlue
        ElseIf sender Is lblHewan Then
            panelHewan.BackColor = Color.LightSkyBlue
        ElseIf sender Is lblBooking Then
            panelBooking.BackColor = Color.LightSkyBlue
        ElseIf sender Is lblPembayaran Then
            panelPembayaran.BackColor = Color.LightSkyBlue
        Else

...
Partial Class FormAdmin
    ...
    Private Sub InitializeComponent()
        ...
        panelLogout.Location = New Point(3, 661)
        ...
        panelTarif.Location = New Point(2, 120)
        panelTarif.Margin = New Padding(2)
        panelTarif.Name = "panelTarif"
        panelTarif.Size = New Size(285, 80)
        ...
        lblTarif.Location = New Point(9, 0)
        lblTarif.Margin = New Padding(2, 0, 2, 0)
        lblTarif.Name = "lblTarif"
        lblTarif.Padding = New Padding(23, 27, 0, 0)
        lblTarif.Size = New Size(189, 54)
        lblTarif.TabIndex = 2
        ...
        panelIndicatorTarif.Margin = New Padding(2)
        panelIndicatorTarif.Name = "panelIndicatorTarif"
        panelIndicatorTarif.Size = New Size(9, 80)
        ...
        panelIndicatorUser.Margin = New Padding(2)
        ...
        panelMasterData.Margin = New Padding(2)

...
Partial Class uc_DataHewan
    ...
    Private Sub InitializeComponent()
        ...
        ' Label1
        ' 
        Label1.Font = New Font("Microsoft PhagsPa", 10.875F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        ' Label2
        ' 
        Label2.Font = New Font("Microsoft PhagsPa", 10.875F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Label2.Location = New Point(39, 102)
        Label2.Name = "Label2"
        Label2.Size = New Size(214, 48)
        Label2.TabIndex = 1
        Label2.Text = "Nama Hewan"
        ' 
        ' Label3
        ' 
        Label3.Font = New Font("Microsoft PhagsPa", 10.875F)
        ...
        ' Label4
        ' 
        Label4.Font = New Font("Microsoft PhagsPa", 10.875F)
        Label4.Location = New Point(39, 242)
        Label4.Name = "Label4"
        ...
        Label5.Location = New Point(841, 35)
        Label5.Name = "Label5"
        ...
        Label6.Location = New Point(841, 105)
        Label6.Name = "Label6"
        ...
        Label8.Location = New Point(841, 245)
        Label8.Name = "Label8"
        ...
        ' cbOwner
        ' 
        cbOwner.Font = New Font("Microsoft Sans Serif", 8.25F)
        cbOwner.Location = New Point(279, 38)
        cbOwner.Name = "cbOwner"
        cbOwner.Size = New Size(314, 34)
        cbOwner.TabIndex = 8
        ' 
        ' txtNama
        ' 
        txtNama.Font = New Font("Microsoft Sans Serif", 8.25F)
        txtNama.Location = New Point(279, 108)
        txtNama.Name = "txtNama"
        txtNama.Size = New Size(314, 32)
        txtNama.TabIndex = 9
        ' 
        ' cbJenis
        ' 
        cbJenis.Font = New Font("Microsoft Sans Serif", 8.25F)
        cbJenis.Items.AddRange(New Object() {"Kucing", "Anjing", "Kelinci", "Hamster"})
        cbJenis.Location = New Point(279, 178)
        cbJenis.Name = "cbJenis"
        cbJenis.Size = New Size(314, 34)
        cbJenis.TabIndex = 10
        ' 
        ' txtRas
        ' 
        txtRas.Font = New Font("Microsoft Sans Serif", 8.25F)
        txtRas.Location = New Point(279, 248)
        txtRas.Name = "txtRas"
        txtRas.Size = New Size(314, 32)
        txtRas.TabIndex = 11
        ' 
        ' cbJK
        ' 
        cbJK.Font = New Font("Microsoft PhagsPa", 10.875F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        cbJK.Items.AddRange(New Object() {"Jantan", "Betina"})
        cbJK.Location = New Point(1081, 32)
        cbJK.Name = "cbJK"
        cbJK.Size = New Size(314, 45)
        cbJK.TabIndex = 12
        ' 
        ' txtUmur
        ' 
        txtUmur.Font = New Font("Microsoft PhagsPa", 10.875F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        txtUmur.Location = New Point(1081, 102)
        txtUmur.Name = "txtUmur"
        txtUmur.Size = New Size(202, 45)
        txtUmur.TabIndex = 13
        ' 
        ' txtWarna
        ' 
        txtWarna.Font = New Font("Microsoft PhagsPa", 10.875F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        txtWarna.Location = New Point(1081, 175)
        txtWarna.Name = "txtWarna"
        txtWarna.Size = New Size(314, 45)
        txtWarna.TabIndex = 14
        ' 
        ' txtBerat
        ' 
        txtBerat.Font = New Font("Microsoft PhagsPa", 10.875F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        txtBerat.Location = New Point(1081, 248)
        txtBerat.Name = "txtBerat"
        txtBerat.Size = New Size(202, 45)
        txtBerat.TabIndex = 15
        ' 
        ' btnTambah
        ' 
        btnTambah.Font = New Font("Microsoft PhagsPa", 12F)
        btnTambah.Location = New Point(1542, 142)
        btnTambah.Name = "btnTambah"
        btnTambah.Size = New Size(186, 60)
        ...
        btnEdit.Location = New Point(1542, 228)
        btnEdit.Name = "btnEdit"
        btnEdit.Size = New Size(186, 60)
        btnEdit.TabIndex = 17
        btnEdit.Text = "Edit"
        ' 
        ' btnHapus
        ...
        btnHapus.Location = New Point(1542, 311)
        btnHapus.Name = "btnHapus"
        btnHapus.Size = New Size(186, 60)
        ...
        dgvHewan.Location = New Point(127, 660)
        dgvHewan.Name = "dgvHewan"
        dgvHewan.RowHeadersWidth = 62
        dgvHewan.Size = New Size(1695, 462)
        ...
        Panel4.Controls.Add(btnHapus)
        Panel4.Location = New Point(94, 180)
        Panel4.Name = "Panel4"
        Panel4.Size = New Size(1778, 453)
        Panel4.TabIndex = 21
        ' 
        ' Panel3
        ' 
        ...
        Panel3.Name = "Panel3"
        Panel3.Size = New Size(1456, 328)
        Panel3.TabIndex = 16
        ' 
        ' Label11
        ' 
        Label11.Font = New Font("Microsoft PhagsPa", 10.875F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Label11.Location = New Point(1353, 248)
        Label11.Name = "Label11"
        Label11.Size = New Size(62, 48)
        Label11.TabIndex = 17
        Label11.Text = "kg"
        ' 
        ' Label9
        ...
        Label9.Location = New Point(1321, 102)
        Label9.Name = "Label9"
